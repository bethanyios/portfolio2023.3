...
<a href="https://www.yallacooperative.com/" rel="noreferrer" target="_blank"><img src={yalla} alt="logo" className="logo-y"/></a>
    ...
    <p>I have converted the paper exercises into a digital format, using tailored design thinking workshops, and I've led research with various methods, including remote and prison-based usability testing. I spearheaded audio production as a feature we prioritised for accessibility.
After launching the pilot, I have led diary studies and user interviews, driving community rollout success and a whitelabel app for diverse organizations.</p>
