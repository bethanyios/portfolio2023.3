...
<a href="https://www.yallacooperative.com/" rel="noreferrer" target="_blank"><img src={yalla} alt="logo" className="logo-y"/></a>
    ...
    <p>Turning Pages was originally developed for prison leavers on probation learning how to read. Shannon Trust has led a reading intervention program in prisons for over 20 years, using actual books and peer learning. </p>
    ...
    <p>The Social Mobility Foundation (SMF) approached Yalla to digitally transform their organisation. As well as the UX designer, I was tasked with serving as the overall Project Manager, a welcome challenge for me and an opportunity to develop management skills.</p>
    <p>In my designer role, I redesigned the student application form to raise conversion rates and the Employer Index Report webpage, catering to high-level corporations aiming to grasp their social mobility impact. I ran weekly co-design sessions with young users to facilitate continuous feedback collection, as well as, design thinking workshops with stakeholders.
    ...
    <p>We are currently in the second phase of work with this client, working on a full website transformation.</p>
    ...
    <p>As this tool has many layers it was a challenge to ensure the flow was intuitive. I conducted user interviews and usability testing, revisiting early iterations to create a lean design. It was my recommendation to strip back a lot of the app as the functionality grew so that the user journey was more intuitive.</p>
    My role across projects includes stakeholder management which as well as presenting insights also involves advocating for users when assumptions are not validated in research. Throughout the process volunteers were involved in co-design workshop sessions and in my research. This level of involvement made sure the tool was highly user-centric and rooted in the needs of actual people.</p>
